...
import { LP_TOKENSBASE, TokenInfo, TOKENSBASE } from './token_list'
...
export const FARMS: FarmInfo[] = [
  ...
  {
    name: 'weWETH-SOL',
    lp: { ...LP_TOKENSBASE['weWETH-SOL-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.SRM },
    isStake: false,
  ...
  {
    name: 'weWETH-USDC',
    lp: { ...LP_TOKENSBASE['weWETH-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.SRM },
    isStake: false,
  ...
  {
    name: 'weSAND-USDC',
    lp: { ...LP_TOKENSBASE['weSAND-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.SRM },
    isStake: false,
  ...
  {
    name: 'weMANA-USDC',
    lp: { ...LP_TOKENSBASE['weMANA-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.SRM },
    isStake: false,
  ...
  {
    name: 'wbWBNB-USDC',
    lp: { ...LP_TOKENSBASE['wbWBNB-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.SRM },
    isStake: false,
  ...
  {
    name: 'wePEOPLE-USDC',
    lp: { ...LP_TOKENSBASE['wePEOPLE-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.SRM },
    isStake: false,
  ...
  {
    name: 'CAVE-USDC',
    lp: { ...LP_TOKENSBASE['CAVE-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.CAVE },
    isStake: false,
  ...
  {
    name: 'GENE-USDC',
    lp: { ...LP_TOKENSBASE['GENE-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.GENE },
    isStake: false,
  ...
  {
    name: 'CWAR-USDC',
    lp: { ...LP_TOKENSBASE['CWAR-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.CWAR },
    isStake: false,
  ...
  {
    name: 'SONAR-USDC',
    lp: { ...LP_TOKENSBASE['SONAR-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.SONAR },
    isStake: false,
  ...
  {
    name: 'APT-USDC',
    lp: { ...LP_TOKENSBASE['APT-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.APT },
    isStake: false,
  ...
  {
    name: 'SHILL-USDC',
    lp: { ...LP_TOKENSBASE['SHILL-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.SHILL },
    isStake: false,
  ...
  {
    name: 'DFL-USDC',
    lp: { ...LP_TOKENSBASE['DFL-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.DFL },
    isStake: false,
  ...
  {
    name: 'BOKU-USDC',
    lp: { ...LP_TOKENSBASE['BOKU-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.BOKU },
    isStake: false,
  ...
  {
    name: 'MIMO-SOL',
    lp: { ...LP_TOKENSBASE['MIMO-SOL-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.MIMO },
    isStake: false,
  ...
  {
    name: 'XTAG-USDC',
    lp: { ...LP_TOKENSBASE['XTAG-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.XTAG },
    isStake: false,
  ...
  {
    name: 'TTT-USDC',
    lp: { ...LP_TOKENSBASE['TTT-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.TTT },
    isStake: false,
  ...
  {
    name: 'RUN-USDC',
    lp: { ...LP_TOKENSBASE['RUN-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.RUN },
    isStake: false,
  ...
  {
    name: 'CRWNY-RAY',
    lp: { ...LP_TOKENSBASE['CRWNY-RAY-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.CRWNY },
    isStake: false,
  ...
  {
    name: 'CRWNY-USDC',
    lp: { ...LP_TOKENSBASE['CRWNY-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.CRWNY },
    isStake: false,
  ...
  {
    name: 'REAL-USDC',
    lp: { ...LP_TOKENSBASE['REAL-USDC-V4'] },
    reward: { ...TOKENSBASE.RAY },
    rewardB: { ...TOKENSBASE.REAL },
    isStake: false,
...
// for (const [key, value] of Object.entries(LP_TOKENSBASE)) {
//   const kk = key.split('-')
//   let version = 'V2 '
//   if (kk.length > 2) {
//     version = kk[2] + ' '
